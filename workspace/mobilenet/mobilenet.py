...
def BinMobileNet(input_tensor, input_shape=None, alpha=1, shallow=True, classes=1000):
    ...
    x = Activation('relu')(x)
    x = BinLayer()(x)
    x = Convolution2D(int(64 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False, kernel_regularizer=BinReg())(x)
    x = BatchNormalization()(x)
    x = PReLU()(x)
    ...
    x = Activation('relu')(x)
    x = BinLayer()(x)
    x = Convolution2D(int(128 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False, kernel_regularizer=BinReg())(x)
    x = BatchNormalization()(x)
    x = Activation('relu')(x)
    ...
    x = Activation('relu')(x)
    x = BinLayer()(x)
    x = Convolution2D(int(256 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False, kernel_regularizer=BinReg())(x)
    x = BatchNormalization()(x)
    x = PReLU()(x)
    ...
    x = Activation('relu')(x)
    x = BinLayer()(x)
    x = Convolution2D(int(512 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False, kernel_regularizer=BinReg())(x)
    x = BatchNormalization()(x)
    x = PReLU()(x)
    ...
    x = Activation('relu')(x)
    x = BinLayer()(x)
    x = Convolution2D(int(1024 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False, kernel_regularizer=BinReg())(x)
    x = BatchNormalization()(x)
    x = PReLU()(x)
...
def MobileNet(input_tensor, input_shape=None, alpha=1, shallow=True, classes=1000):
    """Instantiates the MobileNet.Network has two hyper-parameters
        which are the width of network (controlled by alpha)
        and input size.
